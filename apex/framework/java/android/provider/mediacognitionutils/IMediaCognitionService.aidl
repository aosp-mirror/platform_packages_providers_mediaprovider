...
* @hide
*/
oneway interface IMediaCognitionService {
   void processMedia(in List<MediaCognitionProcessingRequest> requests,
    in ICognitionProcessMediaCallbackInternal callback);
   void getProcessingVersions(in ICognitionGetVersionsCallbackInternal callback);
}