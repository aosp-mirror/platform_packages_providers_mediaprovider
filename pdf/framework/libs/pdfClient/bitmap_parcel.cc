...
using pdfClient::BufferReader;
using pdfClient::Extractor;
using pdfClient::FdReader;
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_graphics_pdf_models_BitmapParcel_readIntoBitmap(
