...
#ifndef MEDIAPROVIDER_PDF_JNI_PDFCLIENT_EXTRACTORS_H_
#define MEDIAPROVIDER_PDF_JNI_PDFCLIENT_EXTRACTORS_H_
...
class BufferWriter : public pdfClient::Extractor {
  public:
...
class BufferReader : public pdfClient::Extractor {
  public:
...
class FdWriter : public pdfClient::Extractor {
  public:
...
class FdReader : public pdfClient::Extractor {
  public:
...
#endif  // MEDIAPROVIDER_PDF_JNI_PDFCLIENT_EXTRACTORS_H_