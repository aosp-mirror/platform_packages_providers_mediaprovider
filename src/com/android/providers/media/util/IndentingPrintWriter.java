...
/**
 * A fork of the {@link android.util.IndentingPrintWriter} (which is {@code @hide} and thus is not
 * available for us to use in packages/providers/MediaProvider/).
 */
public class IndentingPrintWriter extends PrintWriter {
    ...
    private final StringBuilder mIndentBuilder = new StringBuilder();
    ...
    private final char[] mSingleChar = new char[1];
