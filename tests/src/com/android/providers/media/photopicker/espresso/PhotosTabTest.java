...
public class PhotosTabTest extends PhotoPickerBaseTest {
    ...
    public void testPhotoGridLayout_photoGrid() {
        ...
        onView(withId(PICKER_TAB_RECYCLERVIEW)).check(new RecyclerViewItemCountAssertion(4));
    ...
    public void testPhotoGridLayout_image() {
        ...
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, ICON_THUMBNAIL_ID);

        // Verify check icon, gif icon and video icon are not displayed
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, position, OVERLAY_GRADIENT_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, position, ICON_CHECK_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, position, ICON_GIF_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, position, VIDEO_CONTAINER_ID);
    }
    ...
    public void testPhotoGridLayout_gif() {
        ...
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, OVERLAY_GRADIENT_ID);
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, ICON_GIF_ID);
    ...
    public void testPhotoGridLayout_video() {
        ...
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, OVERLAY_GRADIENT_ID);
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, VIDEO_CONTAINER_ID);
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, R.id.video_duration);
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, position, R.id.icon_video);
        onView(withRecyclerView(PICKER_TAB_RECYCLERVIEW)
    ...
    public void testPhotoGrid_albumPhotos() {
        ...
        onView(allOf(withText(R.string.picker_category_camera),
                isDescendantOfA(withId(PICKER_TAB_RECYCLERVIEW)))).perform(click());
        ...
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, recentHeaderPosition, dateHeaderTitleId);
        onView(withRecyclerView(PICKER_TAB_RECYCLERVIEW)
        ...
        assertItemDisplayed(PICKER_TAB_RECYCLERVIEW, photoItemPosition, ICON_THUMBNAIL_ID);

        // Verify check icon, gif icon and video icon are not displayed
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, photoItemPosition, OVERLAY_GRADIENT_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, photoItemPosition, ICON_CHECK_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, photoItemPosition, ICON_GIF_ID);
        assertItemNotDisplayed(PICKER_TAB_RECYCLERVIEW, photoItemPosition, VIDEO_CONTAINER_ID);
